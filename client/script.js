...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/someString')
        .then(res => {
            let repeatParam= document.getElementById('repeat-button')
...
const sendQuery = () => {
    axios.get('http://localhost:3000/query-test?myFirstQuery=an-awesome-query&mySecondQuery=another-query')
        .then(res => {
            console.log(res.data)
        })
}
